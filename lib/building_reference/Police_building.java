...
public class Police_building extends DialogFragment {
	//Suppress Warnings for Inflate
		...
		public Dialog onCreateDialog(Bundle savedInstanceState){
			...
			builder.setView(inflater.inflate(R.layout.police_building, null));
			...
			builder.setPositiveButton("Get Directions", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Intent NameOfTheIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.google.com/maps/dir//32.428919,+-85.703919/@32.4320748,-85.7564007,15z/data=!4m7!4m6!1m0!1m3!2m2!1d-85.703919!2d32.428919!3e0"));
