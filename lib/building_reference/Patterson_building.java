...
public class Patterson_building extends DialogFragment {
	//Suppress Warnings for Inflate
		...
		public Dialog onCreateDialog(Bundle savedInstanceState){
			...
			builder.setView(inflater.inflate(R.layout.patterson_building, null));
			...
			builder.setPositiveButton("Get Directions", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Intent NameOfTheIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.google.com/maps/dir//32.434088,+-85.70726/@32.4320748,-85.7564007,15z/data=!4m7!4m6!1m0!1m3!2m2!1d-85.70726!2d32.434088!3e0"));
