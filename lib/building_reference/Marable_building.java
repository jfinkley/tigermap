...
public class Marable_building extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState){
		...
		builder.setView(inflater.inflate(R.layout.marable_building, null));
		...
		builder.setPositiveButton("Get Directions", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				Intent NameOfTheIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.google.com/maps/dir//32.425716,+-85.699969/@32.4320749,-85.7564006,15z/data=!4m7!4m6!1m0!1m3!2m2!1d-85.699969!2d32.425716!3e0"));
