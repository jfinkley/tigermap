...
public class EmeryIV_building extends DialogFragment {
	//Suppress Warnings for Inflate
		...
		public Dialog onCreateDialog(Bundle savedInstanceState){
			...
			builder.setView(inflater.inflate(R.layout.emeryiv_building, null));
			...
			builder.setPositiveButton("Get Directions", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Intent NameOfTheIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.google.com/maps/dir//32.429919,+-85.710813/@32.4343008,-85.7085698,15z/data=!4m7!4m6!1m0!1m3!2m2!1d-85.710813!2d32.429919!3e0"));
