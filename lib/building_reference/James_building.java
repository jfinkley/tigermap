...
public class James_building extends DialogFragment {
	//Suppress Warnings for Inflate
		...
		public Dialog onCreateDialog(Bundle savedInstanceState){
			...
			builder.setView(inflater.inflate(R.layout.james_building, null));
			...
			builder.setPositiveButton("Get Directions", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Intent NameOfTheIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.google.com/maps/dir//32.432403,+-85.704018/@32.4320748,-85.7564007,15z/data=!4m7!4m6!1m0!1m3!2m2!1d-85.704018!2d32.432403!3e0"));
