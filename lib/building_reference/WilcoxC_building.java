...
public class WilcoxC_building extends DialogFragment {
	//Suppress Warnings for Inflate
		...
		public Dialog onCreateDialog(Bundle savedInstanceState){
			...
			builder.setView(inflater.inflate(R.layout.wilcoxc_building, null));
			...
			builder.setPositiveButton("Get Directions", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Intent NameOfTheIntent = new Intent(Intent.ACTION_VIEW,Uri.parse("https://www.google.com/maps/dir//32.429914,+-85.708835/@32.4320748,-85.7564007,15z/data=!4m7!4m6!1m0!1m3!2m2!1d-85.708835!2d32.429914!3e0"));
